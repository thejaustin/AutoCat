...
class PerplexityProvider(
    ...
    override suspend fun suggestTabs(
        ...
        try {
            ...
            throw LLMException("Perplexity tab suggestion failed: ${e.message}", e)
        }
    }
    ...
    override suspend fun suggestFolders(
        ...
        try {
            ...
            throw LLMException("Perplexity folder suggestion failed: ${e.message}", e)
        }
    }
  ...
  "results": {
    ...
    private fun parseFolderSuggestionResponse(responseJson: String): List<SuggestedFolder> {
        try {
            ...
            throw LLMException("Failed to parse Perplexity folder suggestion response: ${e.message}", e)
        }
    }
