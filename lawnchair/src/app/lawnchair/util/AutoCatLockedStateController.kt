...
object AutoCatLockedStateController {

    private const val TAG = "AutoCatLockedStateController"
    ...
    private val backgroundThread: HandlerThread by lazy {
        HandlerThread("Recents-AutoCatLockedStateController", 10)
    }
    ...
    fun initialize(context: Context): AutoCatLockedStateController {
