...
/**
 * Represents a user-defined custom category for organizing apps.
 *
 * Users can create custom categories beyond the default ones, assign custom
 ...
 * @property isVisible Whether this category should be shown in the drawer
 * @property createdAt Timestamp of category creation (milliseconds since epoch)
 */
...
data class CustomCategory(
    ...
    companion object {
        ...
        /**
         * Creates default categories with standard colors and ordering.
         */
        fun getDefaultCategories(): List<CustomCategory> = listOf(
            CustomCategory(name = "Games", colorHex = COLOR_GAMES, sortOrder = 0),
            CustomCategory(name = "Social", colorHex = COLOR_SOCIAL, sortOrder = 1),
            CustomCategory(name = "Productivity", colorHex = COLOR_PRODUCTIVITY, sortOrder = 2),
