...
**Format**: `15.0-autocat.{BUILD_NUMBER}`

- `15.0` = Lawnchair base version (currently tracking Lawnchair 15.0 Beta 1)
- `autocat` = Fork identifier
- `{BUILD_NUMBER}` = Incremental build number from GitHub Actions

Example: `v15.0-autocat.5` = AutoCat build #5 based on Lawnchair 15.0

---

## [Unreleased]

## [15.0-autocat.5] - 2025-11-23 (Upcoming)

### Added
- **AutoCat Versioning System**: Proper version tracking for AutoCat builds
  - Version format: `15.0-autocat.{BUILD_NUMBER}`
...
- **Versioned Releases**: Each build creates a permanent versioned release
  ...
  - `v15.0-autocat.X` = Permanent versioned releases
...
# Specific version
https://github.com/thejaustin/AutoCat/releases/tag/v15.0-autocat.5
```
